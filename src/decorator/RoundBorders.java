...
/*
 * Decorator: wraps chess board with pretty outline*/
public class RoundBorders implements DisplayMessage
{
    ...
    public void display(String text)
    {
        ...
        for(String line : lines)
        {
            scroll.append("│  ").append(line).append(" ".repeat(max_width - (line.length() - countOccurrences(line))))
                  .append("  │\n");
        }
        scroll.append("│  ").append(" ".repeat(max_width)).append("  │\n");
        scroll.append("╰──").append("─".repeat(max_width)).append("──╯\n");
    ...
    /*
     * Counts and retrieves number of spaces that been miscounted due to ANSI color codes */
